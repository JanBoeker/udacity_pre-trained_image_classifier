...
def get_input_args():
    ...
    parser.add_argument('--arch', type = str, default = 'vgg', help = 'CNN model architecture of pet images')
    
    # Argument 3: name of text file with dogs names 
    parser.add_argument('--dogfile', type = str, default = 'dognames.txt', help = 'text file, containing dognames')
