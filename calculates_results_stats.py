...
def calculates_results_stats(results_dic):
    ...
    if __name__ == '__main__':
        print('Input - Results Dictionary: {}'.format(results_dic))
    ...
    for key in results_dic:
        if results_dic[key][3] == 1:
            n_dogs_img += 1
            list_of_breeds.append(results_dic[key][0])
    ...
    if n_images > 0:
        ...
        results_stats_dic['pct_match'] = 'not applicable'
    
    # percentage of correctly classified dogs
    if n_dogs_img > 0:
        results_stats_dic['pct_correct_dogs'] = (n_correct_dogs / n_dogs_img) * 100
    else:
        results_stats_dic['pct_correct_dogs'] = 'not applicable'
    
    # percentage of correctly classified dog breeds   
    if n_dogs_img > 0:
        results_stats_dic['pct_correct_breed'] = (n_correct_breed / n_dogs_img) * 100        
    else:
        results_stats_dic['pct_correct_breed'] = 'not applicable'
    
    # percentage of correctly classified NON-dogs
    if n_notdogs_img > 0:
        results_stats_dic['pct_correct_notdogs'] = (n_correct_notdogs / n_notdogs_img) * 100 
    else:
        results_stats_dic['pct_correct_notdogs'] = 'not applicable'
        
    if __name__ == '__main__':
        print('Output - Results Statistics Dictionary: {}'.format(results_stats_dic))
    
    return results_stats_dic

if __name__ == '__main__':
    calculates_results_stats({'Beagle_01125.jpg' : ['beagle', 'beagle', 1, 1, 1], 'Beagle_01126.jpg' : ['beagle', 'beagle', 1, 1, 1]})